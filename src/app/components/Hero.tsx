    ...
    <section className="py-28">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image src="/projects/profile.png" alt="Profile" width={100} height={100} className="rounded-full mb-4 w-32 h-32 object-cover ring-2 ring-primary" />
          </motion.div>
          <motion.h1 
          ...
          >
            Software Engineer | Full Stack & Cloud Developer | Empowering the Next Generation of Coders
          </motion.p>
          <motion.div 
